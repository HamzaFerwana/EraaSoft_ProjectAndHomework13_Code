...
export default function App() {
  ...
  const deleteLastTransaction = () => {
    const lastTransaction = trasnactions[trasnactions.length - 1];
    if (lastTransaction) {
      ...
      setTransactions(trasnactions.slice(0, -1));
    }
  }
                  ...
                  <th>
                    {
                      (trasnactions.length - 1 == index) && (
                        <button className='btn btn-danger' onClick={deleteLastTransaction}>
                          Delete
                        </button>
                      )
